...
values (1, 'doom', 'horror', 50,
        '"doom" is a pioneering first-person shooter game that pits players against demons in a high-octane battle for survival. Launched in 1993,'
            ' it''s celebrated for revolutionizing the genre with its intense gameplay and graphics.', 'doomimage',CURRENT_TIMESTAMP);
...
VALUES (2, 'Minecraft', 'Sandbox', 26.95,
        ...
        ' it''s become a phenomenon for its creative freedom and community-driven content."', 'minecraftimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
...
VALUES (4, 'Dark Souls', 'RPG', 39.99,
        ...
        ' it has captivated players with its emphasis on exploration and player skill."', 'darksoulsimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (5, 'Fortnite', 'Battle Royale', 20.5,
        ...
        ' it has dominated the gaming scene with its free-to-play model and cultural impact."', 'fortniteimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (6, 'The Witcher 3: Wild Hunt', 'RPG', 49.99,
        ...
        'witcherimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (7, 'Super Mario Odyssey', 'Platformer', 59.99,
        ...
        ' it''s renowned for its creativity and charm."', 'marioimage',CURRENT_TIMESTAMP);
...
VALUES (8, 'Grand Theft Auto V', 'Action-Adventure', 29.99,
        ...
        ' it has become one of the best-selling video games of all time."', 'gtaimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (9, 'Among Us', 'Party', 5,
        ...
        'amongusimage',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (10, 'Animal Crossing: New Horizons', 'Simulation', 59.99,
        ...
        'horizonsimage',CURRENT_TIMESTAMP);
