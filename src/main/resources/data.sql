insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
values (1, 'doom', 'horror', 50,
        '"doom" is a pioneering first-person shooter game that pits players against demons in a high-octane battle for survival. Launched in 1993,'
            ' it''s celebrated for revolutionizing the genre with its intense gameplay and graphics.', 'doom_image.jpg',CURRENT_TIMESTAMP);

insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (2, 'Minecraft', 'Sandbox', 26.95,
        ...
        ' it''s become a phenomenon for its creative freedom and community-driven content."', 'minecraft_image.jpg',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (3, 'The Legend of Zelda: Breath of the Wild', 'Adventure', 59.99,
        ...
        'zelda_image.jpeg',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (4, 'Dark Souls', 'RPG', 39.99,
        ...
        ' it has captivated players with its emphasis on exploration and player skill."', 'darksouls_image.jpg',CURRENT_TIMESTAMP);

insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (5, 'The Witcher 3: Wild Hunt', 'RPG', 49.99,
        ...
        'witcher_image.png',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (6, 'Super Mario Odyssey', 'Platformer', 59.99,
        ...
        ' it''s renowned for its creativity and charm."', 'mario_image.png',CURRENT_TIMESTAMP);

insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (7, 'Grand Theft Auto V', 'Action-Adventure', 29.99,
        ...
        ' it has become one of the best-selling video games of all time."', 'gta_image.png',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (8, 'Among Us', 'Party', 5,
        ...
        'amongus_image.png',CURRENT_TIMESTAMP);
insert into Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CREATED_AT)
VALUES (9, 'Animal Crossing: New Horizons', 'Simulation', 59.99,
        ...
        'horizons_image.png',CURRENT_TIMESTAMP);
