...
values ( 'doom', 'Horror', 50,
        '"doom" is a pioneering first-person shooter game that pits players against demons in a high-octane battle for survival. Launched in 1993,'
            ' it''s celebrated for revolutionizing the genre with its intense gameplay and graphics.', 'doom_image.jpg','pc','https://www.youtube.com/embed/Ienu85W5Rkk?si=bZi8tjbqesdhI0gQ');
insert into Games( NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CONSOLE,VIDEO_URL)
VALUES ( 'Minecraft', 'Adventure', 26.95,
        ...
        ' it''s become a phenomenon for its creative freedom and community-driven content."', 'minecraft_image.jpg','pc','https://www.youtube.com/embed/EB0A8m2hxrg?si=uLCTh1MSd7ylW-rq');
insert into Games( NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CONSOLE,VIDEO_URL)
...
VALUES ( 'Dark Souls', 'Horror', 39.99,
        ...
        ' it has captivated players with its emphasis on exploration and player skill."', 'darksouls_image.jpg','nintendo','https://www.youtube.com/embed/_zDZYrIUgKE?si=2ChGKJYaLP6uEhID');
...
VALUES ( 'Among Us', 'Horror', 5,
        ...
        'amongus_image.png','ps5','https://www.youtube.com/embed/8SWhBsbxmpk?si=luQFC_yap6P95HU1');
insert into Games( NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME,CONSOLE,VIDEO_URL)
