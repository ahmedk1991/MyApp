...
values (1, 'doom', 'horror', 50,
        '"doom" is a pioneering first-person shooter game that pits players against demons in a high-octane battle for survival. Launched in 1993,'
            ' it''s celebrated for revolutionizing the genre with its intense gameplay and graphics.', 'doomimage');
...
VALUES (2, 'Minecraft', 'Sandbox', 26.95,
        ...
        ' it''s become a phenomenon for its creative freedom and community-driven content."', 'minecraftimage');
INSERT INTO Games(ID, NAME, CATEGORY, PRICE, DESCRIPTION, IMAGE_FILE_NAME)
